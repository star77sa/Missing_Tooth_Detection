...
def main():
    ...
    ### PREDICTION
    # 여기 모델 가중치 불러옴. 원래 주석
    cfg.MODEL.WEIGHTS = os.path.join(cfg.OUTPUT_DIR, "/SSD4/kyeongsoo/implant_code/output/retina_det_100000.pth") ## 이거 이름 바꿔가면서 하기!
    ...
    cv2.imwrite('/SSD4/kyeongsoo/implant_code/ret_det100000.jpg', v.get_image()[:, :, ::-1]) # 이미지 저장
    print("done")
